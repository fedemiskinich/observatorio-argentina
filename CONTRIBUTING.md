# Contributing to Observatorio Argentina

Gracias por tu interés en contribuir. Observatorio Argentina es un proyecto abierto de investigación y desarrollo para integrar y contextualizar señales geoespaciales y fuentes públicas. Las contribuciones deben respetar la procedencia de los datos, la privacidad y las licencias de terceros.
...
Observatorio Argentina is maintained by [Bilawal Sidhu](https://github.com/bilawalsidhu)
