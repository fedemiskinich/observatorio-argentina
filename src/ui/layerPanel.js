...
const PANEL_LABELS = {
  'ais-live-vessels': 'Embarcaciones AIS · Argentina',
  bikeshare: 'Bike Share',
  cctv: 'Cameras',
  'alpr-cameras': 'Mapped ALPR Cameras',
  'local-datacenters': 'Data Centers',
  'local-firms': 'Active Fires',
  'ign-airports': 'Aeropuertos · IGN',
  'ign-ports': 'Puertos · IGN',
  'ign-localities': 'Localidades · IGN',
  'custom-map-elements': 'Elementos personalizados',
};
