  ...
  _initCctvPanel() {
    ...
    this._cctvControls = new CctvControls({
      elements: {
        ...
        _cctvWebFrame: this._cctvWebFrame,
        _cctvLiveWindow: this._cctvLiveWindow,
        _cctvLiveFrame: this._cctvLiveFrame,
        _cctvLiveTitle: this._cctvLiveTitle,
        _cctvLiveSource: this._cctvLiveSource,
        _cctvLiveClose: this._cctvLiveClose,
