...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _cctvWebFrame: document.getElementById('cctv-web-frame'),
    _cctvLiveWindow: document.getElementById('cctv-live-window'),
    _cctvLiveFrame: document.getElementById('cctv-live-frame'),
    _cctvLiveTitle: document.getElementById('cctv-live-title'),
    _cctvLiveSource: document.getElementById('cctv-live-source'),
    _cctvLiveClose: document.getElementById('cctv-live-close'),
