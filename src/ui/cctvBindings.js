export function _initCctvPanel() {
  ...
  this.listen(this._cctvLiveClose, 'click', () => {
    this._dismissedEmbedCameraId = this._cctvState?.activeCameraId || null;
    if (this._cctvLiveWindow) this._cctvLiveWindow.hidden = true;
