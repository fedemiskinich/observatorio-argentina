...
import { createApplicationHydrology } from './layers/hydrology.js';
import { createApplicationCustomElements } from './layers/customElements.js';
  ...
  try {
    ...
    const catalog = createLayerCatalog(
      [
        ...
        createApplicationHydrology({ source: sources.hydrology }),
        createApplicationCustomElements(),
