...
export const CITY_POIS = {
  buenosaires: {
    ...
    groundElevation: 25,
    viewBounds: {
      southwest: { lat: -34.72, lng: -58.54 },
      northeast: { lat: -34.5, lng: -58.32 },
    },
    pois: [
      {
        name: 'Casa Rosada',
      ...
      {
        name: 'Congreso de la Nación Argentina',
        lat: -34.6098,
        lon: -58.3926,
        alt: 650,
        pitch: -27,
  ...
  corrientes: {
    ...
    groundElevation: 62,
    viewBounds: {
      southwest: { lat: -27.55, lng: -58.91 },
      northeast: { lat: -27.4, lng: -58.75 },
    },
    pois: [
      {
        name: 'Puente General Belgrano',
        lat: -27.4666,
        lon: -58.859,
        alt: 1300,
        pitch: -23,
      ...
      {
        name: 'Casa de Gobierno de Corrientes',
        lat: -27.4697,
        lon: -58.8328,
        alt: 500,
        pitch: -27,
